...
my_downloader.search_urls('people wearing Protective Glasses',limit=10, verbose=True)
...
my_downloader.download('people wearing Protective Glasses', limit=10)
...
my_downloader.download('people wearing Protective Glasses', limit=10, verbose=True)
#response.download(keywords = "worker wearing safety glasses, people wearing Protective Glasses", limit = 2000)